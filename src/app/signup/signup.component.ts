...
import { newCreator } from './signup.model';
...
export class SignupComponent {
 ...
 /* onSubmit() {
  ...
  if (this.signupForm.valid) {
    ...
    this.signupService.registerCreator(newcreatorData).subscribe({
      next: (res: newCreator) => {
        console.log('User registered:', res);
        this.signupService.newcreators.update(state => [...state, res]);  // ⬅️ preserve signal update
        this.router.navigate(['/home']);
      },
      error: (err: any) => {
